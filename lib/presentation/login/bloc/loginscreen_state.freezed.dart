...
part of 'loginscreen_state.dart';
...
class _$_LoginScreenState implements _LoginScreenState {
  ...
  @override
  String toString() {
    return 'LoginScreenState(isLoading: $isLoading, hasError: $hasError, errorCode: $errorCode, errorMessage: $errorMessage, apiUrl: $apiUrl, appVersion: $appVersion, url: $url, isLoggedIn: $isLoggedIn, didFinish: $didFinish, loginResponseModel: $loginResponseModel, userProfileModel: $userProfileModel)';
  }
...
abstract class _LoginScreenState implements LoginScreenState {
  factory _LoginScreenState(
      ...
      bool didFinish,
      LoginResponseModel? loginResponseModel,
      UserProfileModel? userProfileModel}) = _$_LoginScreenState;
